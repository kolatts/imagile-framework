...
using Imagile.Framework.Blazor.ApplicationInsights.Models.Context;
using OperatingSystem = Imagile.Framework.Blazor.ApplicationInsights.Models.Context.OperatingSystem;

namespace Imagile.Framework.Blazor.ApplicationInsights.Models;

/// <summary>
/// Telemetry context containing contextual information about the telemetry.

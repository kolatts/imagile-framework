...
/// <summary>
/// Page view performance telemetry for tracking page load metrics.
...
/// <summary>
/// JSON converter for TimeSpan to format for Application Insights.
/// </summary>
...
{
    /// <summary>
    /// Read is not implemented as conversion from JSON to TimeSpan is not needed.
    /// </summary>
    ...
    /// <summary>
    /// Writes TimeSpan to JSON in general format.
    /// </summary>

...
/// <summary>
/// Blazor component that initializes the Application Insights JavaScript SDK and provides automatic page tracking.
/// </summary>
/// <remarks>
/// <para>
/// Add this component to your App.razor to enable Application Insights telemetry.
/// The component generates the JavaScript SDK snippet, initializes the SDK on first render,
/// and automatically tracks page views when navigation occurs.
/// </para>
/// <para>
/// Navigation tracking subscribes to <see cref="NavigationManager.LocationChanged"/> to send
/// page view telemetry whenever the user navigates to a different route.
/// </para>
/// </remarks>
/// <example>
/// <code>
...
public partial class ApplicationInsightsInit : ComponentBase, IDisposable
{
    ...
    protected override void OnInitialized()
    {
        ...
        // Subscribe to navigation changes for automatic page tracking
        ...
        script += $"<script type=\"text/javascript\">{BlazerApplicationInsightsJs}</script>";
    }
    ...
    /// <summary>
    /// Handles navigation location changes to track page views automatically.
    /// </summary>

...
<task type="auto">
  ...
  <action>
    ...
    6. Migrate existing AddBlazorApplicationInsights(Action<Config>, Func<IApplicationInsights, Task>?, bool) method
    7. After migrating existing method, add IConfiguration overload for appsettings.json binding:
       ```csharp
...
<task type="auto">
  ...
  <verify>
    `type src\Imagile.Framework.Blazor.ApplicationInsights\Components\ApplicationInsightsInit.razor.cs | findstr "NavigationManager"`
  </verify>
...
<task type="auto">
  ...
  <action>
    ...
    **Migrate JS module:**
    ...
    3. This module provides: addTelemetryInitializer, trackDependencyData, getContext, cookieManager* methods
  ...
  <verify>
    `type src\Imagile.Framework.Blazor.ApplicationInsights\Components\ApplicationInsightsErrorBoundary.cs | findstr "class ApplicationInsightsErrorBoundary"`
  </verify>
